...
const VanillaCakes = () => {
  ...
  // Filter cakes for vanilla cakes
  const getFilteredCakes = () => {
    let filteredCakes = cakes.filter(cake => 
      cake.flavor?.toLowerCase().includes('vanilla') ||
      cake.name?.toLowerCase().includes('vanilla') ||
      cake.description?.toLowerCase().includes('vanilla')
    );
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-rose-50 to-amber-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading vanilla cakes...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
            Classic vanilla cakes with a modern twist. Perfect for those who love the timeless elegance of vanilla flavor!
          </p>
        </div>
        ...
        <div className="w-full">
          {filteredCakes.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">No vanilla cakes found matching your criteria.</p>
              <button
                onClick={() => setFilters({
                  priceRange: [0, 2000],
                  rating: 0,
            ...
            <div className="mb-16">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  {filteredCakes.length} vanilla cake{filteredCakes.length !== 1 ? 's' : ''} found
                </p>
              </div>
