...
const GraduationCakes = () => {
  ...
  // Filter cakes for graduation cakes
  const getFilteredCakes = () => {
    let filteredCakes = cakes.filter(cake => 
      cake.tag?.toLowerCase().includes('graduation') ||
      cake.description?.toLowerCase().includes('graduation') ||
      cake.name?.toLowerCase().includes('graduation')
    );
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-rose-50 to-amber-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading graduation cakes...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
            Celebrate academic achievements with our special graduation cakes. Perfect for marking this important milestone!
          </p>
        </div>
        ...
        <div className="w-full">
          {filteredCakes.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">No graduation cakes found matching your criteria.</p>
              <button
                onClick={() => setFilters({
                  priceRange: [0, 2000],
                  rating: 0,
            ...
            <div className="mb-16">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  {filteredCakes.length} graduation cake{filteredCakes.length !== 1 ? 's' : ''} found
                </p>
              </div>
...
export default GraduationCakes; 